...
const NavigationTracker = ({ sections = [] }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 lg:px-12 py-4 bg-black bg-opacity-20 backdrop-blur-sm transition-all duration-300">
